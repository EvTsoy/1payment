...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\FindRangeController' => 'getFindRangeControllerService',
            'App\\Controller\\ValueController' => 'getValueControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventListener\\Redirect404Listener')] fn () => ($container->privates['App\\EventListener\\Redirect404Listener'] ?? $container->load('getRedirect404ListenerService')), '__invoke'], 0);
